...
public class Application
{
    ...
    public static void main(String[] args)
    {
       ...
       //df.displayCity(cityEurope);
        ...
        int LIMIT = 10;
        // I want to view the top (LIMIT) populated capital cities in a region. Issue 25. Completed 16/03/2020 by Gale.
        System.out.println("I want to view the top " + LIMIT + " populated capital cities in a region. Issue 25.");
        ArrayList<CapitalCity> capCityInRegion = capCityFunc.capCityInRegion(dc.database(), LIMIT);
        df.displayCapitalCity(capCityInRegion);
